...
class VideosApiTest extends TestCase
{
     ...
     * @test
     */
    public function regular_user_cannot_update_videos()
    {
     ...
     * @test
     */
    public function guest_user_cannot_update_videos()
    {
     ...
     * @test
     */
    public function regular_user_cannot_destroy_videos()
    {
        $this->loginAsRegularUser();
        $video = Video::create([
            'title' => 'TDD 101',
     ...
     * @test
     */
    public function guest_user_cannot_destroy_videos()
    {
     ...
     * @test
     */
    public function regular_user_cannot_store_videos()
    {
        $this->loginAsRegularUser();
     ...
     * @test
     */
    public function guest_user_cannot_store_videos()
    {
    ...
    {
        Auth::login(create_regualar_user());
    }
}
